    ...
    return {
        ...
        initChart:function(){
              $("#doughnutChart").drawDoughnutChart([
                { title: "Web Development",         value : 50,  color: "#e74c3c" },
                { title: "Development",            value:  25,   color: "#f1c40f" },
                { title: "Designing",           value:  10,   color: "#3498db" },
                { title: "Surfing the Internet",           value : 15,   color: "#1dd2af" }
              ], {
                summaryTitle: '</p><h1>Skills & co.</h1><p>',
              });
        },  
